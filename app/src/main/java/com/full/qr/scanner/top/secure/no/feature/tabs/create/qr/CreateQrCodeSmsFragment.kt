...
import com.full.qr.scanner.top.secure.no.model.schema.Sms
...
class CreateQrCodeSmsFragment : BaseCreateBarcodeFragment() {
    ...
    private fun handleTextChanged() {
        fragmentView.findViewById<EditText>(R.id.edit_text_phone).addTextChangedListener { toggleCreateBarcodeButton() }
        fragmentView.findViewById<EditText>(R.id.edit_text_message).addTextChangedListener { toggleCreateBarcodeButton() }
    }

    private fun toggleCreateBarcodeButton() {
        parentActivity.isCreateBarcodeButtonEnabled = fragmentView.findViewById<EditText>(R.id.edit_text_phone).isNotBlank() || fragmentView.findViewById<EditText>(R.id.edit_text_message).isNotBlank()
    }
}